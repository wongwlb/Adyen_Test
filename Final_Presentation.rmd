...
#### The previous question caught my eye, where column "purpose" indicated why people took loans.
#### As such, I sought to find out what the probability of unpaid loans was among the different loan purposes.
...
### This graph would go to show that educational loans are rather high risk, where almost a quarter (0.25%) of them are unpaid. Thus, the stakeholder might find it wise to limit the instances of educational loans.